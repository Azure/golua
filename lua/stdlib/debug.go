...
// OpenDebug open the Lua standard debug library. This library provides the functionality of the
...
// the current thread.
func OpenDebug(state *lua.State) int {
	// Create 'debug' table.
...
func dbgGetMetaTable(state *lua.State) int {
	unimplemented("debug: getmetatable")
	return 0
}
...
func dbgGetRegistry(state *lua.State) int {
	unimplemented("debug: getregistry")
	return 0
}
...
func dbgGetUserValue(state *lua.State) int {
	unimplemented("debug: getuservalue")
	return 0
}
...
func dbgSetMetaTable(state *lua.State) int {
	unimplemented("debug: setmetatable")
	return 0
}
...
func dbgSetUserValue(state *lua.State) int {
	unimplemented("debug: setuservalue")
	return 0
}
...
func dbgUpValueJoin(state *lua.State) int {
	unimplemented("debug: upvaluejoin")
	return 0
}
